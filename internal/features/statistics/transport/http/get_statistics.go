...
// @Description Получение статистики по задачам с опциональной фильтрацией по user_id и/или временному промежутку времени
// @Tags 		statistics
// @Produce 	json
...
// @Success 	200 {object} GetStatisticsResponse 			  "Успешное получения статистики"
