...
type PatchUserRequest struct {
	...
	PhoneNumber core_http_types.Nullable[string] `json:"phone_number" swaggertype:"string" example:"+79962172778"`
}
...
// @Description 2. **Явно передано значение**: `"phone_number": "+79962172778"` - устанавливается новый номер телефона в БД
